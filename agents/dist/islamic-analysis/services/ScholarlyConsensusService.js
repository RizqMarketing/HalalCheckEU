...
exports.ScholarlyConsensusService = void 0;
const Logger_1 = require("../../../core/infrastructure/logging/Logger");
class ScholarlyConsensusService {
    constructor(logger) {
        this.logger = logger || new Logger_1.Logger('ScholarlyConsensusService');
        this.madhabRulings = new Map();
        this.initializeMadhabRulings();
    }
    initializeMadhabRulings() {
    ...
    addMadhabRulings(ingredient, rulings) {
        this.madhabRulings.set(ingredient.toLowerCase(), rulings);
    }
    async getMadhabSpecificRuling(ingredient, madhab) {
    ...
    async getConsensusAnalysis(ingredient) {
    ...
    isIngredientInCategory(ingredient, category) {
    ...
    determineConsensusLevel(rulings) {
        if (rulings.length < 2)
            return 'unclear';
    ...
    generateRecommendedApproach(rulings, consensusLevel) {
    ...
    getAlternativeOpinions(rulings) {
        const opinions = [];
...
exports.ScholarlyConsensusService = ScholarlyConsensusService;
//# sourceMappingURL=ScholarlyConsensusService.js.map