    ...
    <div className="bg-gradient-to-br from-green-50 via-white to-blue-50 min-h-screen">
      ...
      <main className="relative overflow-hidden">
          ...
          <div className="text-center">
            <div className="mb-8">
              <span className="inline-flex items-center px-4 py-2 rounded-full text-green-800 bg-green-100 border border-green-200 text-sm font-medium">
                ...
                Trusted by certification professionals
              </span>
            </div>
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="text-center">
              ...
              <p className="mt-4 text-lg text-gray-600">
                Transparent pricing with no hidden fees. Choose the plan that fits your certification needs.
              </p>
            </div>
        ...
        <div className="mt-20 text-center">
          <h2 className="text-3xl font-extrabold text-gray-900">
            Transform Your Halal Certification Process
          </h2>
          <p className="mt-4 text-lg text-gray-600">
          ...
          <div className="mt-8 space-y-4">
            ...
            <p className="text-sm text-gray-500">
              14-day free trial • Professional support • Cancel anytime
            </p>
          </div>
        </div>
      </main>
