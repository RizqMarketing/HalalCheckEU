  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
      ...
      <div className="relative">
        ...
        {/* Dropdown Menu */}
        {isOpen && (
          <div className="absolute bottom-full right-0 mb-2 w-80 bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden">
