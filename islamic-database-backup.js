...
function getHardcodedDatabase() {
    return [
        ...
        },
        {
            ...
            confidence: 95,
            reasoning: 'Derived from crushed cochineal insects. Most scholars consider insects haram except locusts.',
        },
        ...
        },
        {
            ...
            category: 'Basic Ingredients',
            confidence: 100,
            reasoning: 'Natural mineral, permissible in Islamic law.',
        },
        {
            name: 'Sugar',
            status: 'HALAL',
